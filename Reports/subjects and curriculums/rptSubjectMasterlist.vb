...
Public Class rptSubjectMasterlist
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptSubjectMasterlist.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Academic_Manager.rptSubjectMasterlist.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptSubjectMasterlist
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptSubjectMasterlist = New rptSubjectMasterlist()
        rpt.Site = Me.Site
        Return rpt
    End Function
