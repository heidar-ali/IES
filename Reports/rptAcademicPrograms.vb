...
Public Class rptAcademicPrograms
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptAcademicPrograms.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Academic_Manager.rptAcademicPrograms.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptAcademicPrograms
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptAcademicPrograms = New rptAcademicPrograms()
        rpt.Site = Me.Site
        Return rpt
    End Function
